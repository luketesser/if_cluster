#' cluster_dre
#'
#' @param data_path The path to the data file, for example: "Data/if_dre_2023_06.csv"
...
#' @param column_to_cluster The name of the column in the data set to cluster, for example: "Resultado antes da Tributação, Lucro e Participação (g) = (e) + (f)"
#'
...
#' @examples
#'
#' clustered_data <- cluster_dre(data_path = "Data/if_dre_2023_06.csv", rmv = 40, column_to_cluster = "Resultado antes da Tributação, Lucro e Participação (g) = (e) + (f)")
#'

cluster_dre <- function(data_path, rmv, column_to_cluster){
